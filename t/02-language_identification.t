...
my %texts = (
             sk => 'Vláda od začiatku novembra výrazne zníži zamestnávateľom odvody pri zamestnaní osoby, ktorá je evidovaná na úrade práce viac ako jeden rok. Takýto zámer v pondelok odobrila Rada solidarity a rozvoja.',
             ...
             'bs_hr' => 'Sva ljudska bića rađaju se slobodna i jednaka u dostojanstvu i pravima. Ona su obdarena razumom i sviješću i treba da jedno prema drugome postupaju u duhu bratstva.',
...
my @langs = sort ( get_all_languages() );

plan tests => 3 + 3 * @langs;
